...
$db = "phadta12_satara"; // your MySQL database name
$mysql_username = "phadta12_clients";  // your MySQL username
$mysql_password = "Kasturi12#$";  // your MySQL password

$from_emailaddress = "phadta12@lin4.plreseller.com";// your email address to show who the email is from (should be different $to_emailaddress)
$report_emailaddress = "srcsyscronmail@gmail.com";//address to send reports, not the backup just details on last backups (can be same as above)
$to_emailaddress = "srcsyscronmail@gmail.com"; // your email address to send backup files to
