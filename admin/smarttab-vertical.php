...
<tr>
  ...
  <p align=center>
  		...
  		<div id="tabs">
  			<ul>
  				<li><a href="#tabs-1"><h2><p align=center>Common</p></h2></a></li>
  				<li><a href="#tabs-2"><h2><p align=center>Home Page</p></h2></a></li>
  				<!-- <li><a href="#tabs-3"><h2><p align=center>&#2357;&#2381;&#2351;&#2357;&#2360;&#2381;&#2341;&#2366;&#2346;&#2344;</p></h2></a></li> 
  				<li><a href="#tabs-4"><h2><p align=center>&#2351;&#2379;&#2332;&#2344;&#2366;</p></h2></a></li> -->
  				<li><a href="#tabs-5"><h2><p align=center>Photo Gallery</p></h2></a></li>
                <li><a href="#tabs-6"><h2><p align=center>Contacts</p></h2></a></li>
				...
				<tr>
					...
					if($num > 0) 
					{
						while($row = mysqli_fetch_array($result)){
					     echo "<img src='../images/$row[0]' width=600 height=75>";
						}
					}
					else
  		...
  		<div id="tabs-2">
            ...
            <legend>Slider</legend>
         	...
         	<hr>
         	 <?php
	     		include('conn.php');	
				$result = mysqli_query($con,"SELECT * FROM slider order by photoid desc") or die('Query Not Executed');
				$i=0;
            ...
            <legend>About Us</legend>
             <table border="0" width="400" height="40" align="center" background='images/shared/image1.jpg'>
				<tr>
					...
					<?php
	   		   		include('conn.php');	
					$result = mysqli_query($con,"SELECT * FROM aboutus where id=10") or die('Query Not Executed');
					$num = mysqli_num_rows($result);
					if($num > 0) 
					{
						while($row = mysqli_fetch_array($result))
        ...
        <div id="tabs-5">
            ...
            <legend>फोटो समूह</legend>
         	...
         	<hr>
         	 <?php
	     		include('conn.php');	
				$result = mysqli_query($con,"SELECT * FROM gallery order by photoid desc") or die('Query Not Executed');
				$i=0;
				echo "<marquee behavior=scroll direction=left scrollamount=7 onmouseout=this.start() onmouseover=this.stop() scrolldelay=90 style='background-color:white;'>"; 
				while($row = mysqli_fetch_array($result)){
            ...
            Type in Marathi (Press Ctrl+g to toggle between English and Marathi) 
             <table border="0" width="550" height="40" align="center">
				...
				<tr>
					...
					<?php
					include('conn.php');	
					$result = mysqli_query($con,"SELECT * FROM branchaddr") or die('Query Not Executed');
					$num = mysqli_num_rows($result);
					if($num > 0) 
					{
